<section class="align-center relative mb-4 flex h-72 flex-col justify-center space-y-4 bg-laravel text-center">
  ...
  <div class="z-10">
    ...
    <div>
      <a href="register.html"
        class="mt-2 inline-block rounded-xl border-2 border-white px-4 py-2 uppercase text-white hover:border-black hover:text-black">
